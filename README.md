...
…Such as the SWTOR Area Assembler and Character Assembler, and the ZG SWTOR Tools. With the settings at default values, none of them should notice any difference. At any other values:

* **SWTOR Character Assembler Add-on**: it should assemble the characters with all objects behaving as per those settings without producing any trouble when posed or animated.
