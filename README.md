...
#### WARNING: Blender 3.6.8 and higher 3.6.x releases introduce a severe incompatibility. Please stay on 3.6.7 or go for 3.6.12 LTS (you can find them in **[this list](https://www.blender.org/download/lts/3-6/)**. Scroll down that page or do a page search by "3.6.12").
