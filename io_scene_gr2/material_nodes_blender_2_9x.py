...
class CreatureShader():
    ...
    def Creature(self):
        ...
        NodeGroup.links.new(Gamma.outputs[0], Principled.inputs[17])
        NodeGroup.links.new(Mul1.outputs[0], Principled.inputs[4])
        NodeGroup.links.new(Mul2.outputs[0], Principled.inputs[6])
        NodeGroup.links.new(RotMap.outputs[0], Principled.inputs[18])
        NodeGroup.links.new(RotMap.outputs[1], Principled.inputs[19])
        NodeGroup.links.new(RotMap.outputs[2], Principled.inputs[20])
...
class EyeShader():
    ...
    def Eye(self):
        ...
        NodeGroup.links.new(Lerp.outputs[0], Principled.inputs[17])
...
class SkinBShader():
    ...
    def SkinB(self):
        ...
        NodeGroup.links.new(Add.outputs[0], Principled.inputs[17])
...
class UberShader():
    ...
    def Uber(self):
        ...
        NodeGroup.links.new(RotationMap.outputs[0], Principled.inputs[18])
        NodeGroup.links.new(RotationMap.outputs[1], Principled.inputs[19])
        NodeGroup.links.new(RotationMap.outputs[2], Principled.inputs[20])
