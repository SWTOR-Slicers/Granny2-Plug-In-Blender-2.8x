...
class ImportCHA(Operator):
    ...
    bl_description = "Import a 'paths.json' file from inside a character folder generated by\nTORCommunity.com's Character Designer or its NPC database's 3D Viewers.\n\n• The folder needs to have been filled with the requisite assets\n   by a Character Assembler tool or by Slicers GUI's Locate tool.\n\n• If importing a NPC, it must NOT be a Creature-type one (single mesh)"
